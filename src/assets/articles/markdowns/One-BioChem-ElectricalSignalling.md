...
<div class="image">
    <div class="img"><img alt="Action potential stages" src="./../images/issue1/biochem/Actionpotential1.png"></img></div>
    <em>This figure [4] shows the stages of the action potential, explained below. Graph of membrane potential (mv) against time (ms)</em>
</div>
